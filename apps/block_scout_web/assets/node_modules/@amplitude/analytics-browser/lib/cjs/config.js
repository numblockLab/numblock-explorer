...
exports.getTopLevelDomain = exports.createTransport = exports.createEventsStorage = exports.createFlexibleStorage = exports.createCookieStorage = exports.useBrowserConfig = exports.BrowserConfig = exports.getDefaultConfig = void 0;
    ...
    return tslib_1.__generator(this, function (_q) {
        switch (_q.label) {
            ...
            case 5:
                ...
                deviceId = (_j = (_h = (_g = options === null || options === void 0 ? void 0 : options.deviceId) !== null && _g !== void 0 ? _g : queryParams.deviceId) !== null && _h !== void 0 ? _h : previousCookies === null || previousCookies === void 0 ? void 0 : previousCookies.deviceId) !== null && _j !== void 0 ? _j : (0, analytics_core_1.UUID)();
                ...
                _e = { cookieStorage: cookieStorage, deviceId: deviceId, domain: domain, lastEventTime: lastEventTime, optOut: optOut, sessionId: sessionId };
                return [4 /*yield*/, (0, exports.createEventsStorage)(options)];
            case 6: return [2 /*return*/, new (_b.apply(BrowserConfig, _c.concat([tslib_1.__assign.apply(void 0, _d.concat([(_e.storageProvider = _q.sent(), _e.trackingOptions = tslib_1.__assign(tslib_1.__assign({}, defaultConfig.trackingOptions), options === null || options === void 0 ? void 0 : options.trackingOptions), _e.transportProvider = (_p = options === null || options === void 0 ? void 0 : options.transportProvider) !== null && _p !== void 0 ? _p : (0, exports.createTransport)(options === null || options === void 0 ? void 0 : options.transport), _e.userId = userId, _e)]))])))()];
        }
    });
}); };
